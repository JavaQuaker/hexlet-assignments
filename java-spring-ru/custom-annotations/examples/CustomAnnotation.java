// Аннотация задается описанием соответствующего интерфейса с ключевым словом @interface
...
// Вызов этого метода вернет значение параметра, переданного в аннотацию
